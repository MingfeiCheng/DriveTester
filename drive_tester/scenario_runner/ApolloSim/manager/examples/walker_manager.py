...
from apollo_sim.agents.walker.waypoint_walker import WaypointWalkerConfig, WaypointWalkerAgent
...
class WalkerManager(SubScenarioManager):

    def __init__(
            self,
            scenario_idx: str,
            config_pool: List[WaypointWalkerConfig],
            sim_env: SimEnv,
            output_folder: str,
            # other configs
            debug: bool = False,
    ):
        super(WalkerManager, self).__init__(
